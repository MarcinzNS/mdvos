...
urlpatterns = [
    ...
    path('pomoc', adminek.pomoc, name="pomoc"),
    path('remove-device-from-db/<int:device_id>', adminek.remove_device_from_db, name="remove_device_from_db"),
    path('accept-device/<int:device_id>/', adminek.accept_device, name="accept_device"),
